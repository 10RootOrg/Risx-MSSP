...
# Fix: upstream uses double quotes, not single quotes
sed -i 's#^UPLOAD_FOLDER = "/tmp"#UPLOAD_FOLDER = \x27/usr/share/timesketch/upload\x27#' timesketch/etc/timesketch/timesketch.conf
